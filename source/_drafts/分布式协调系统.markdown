...
when does master switch?

if a node failed to write data and client connect to it, how to ensure reading the latest data?

why can observer improve performance? 
